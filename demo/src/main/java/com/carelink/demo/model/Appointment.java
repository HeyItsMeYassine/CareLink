...
public class Appointment {
    ...
    public void reschedule(LocalDateTime newTime) {
        ...
        String msg = "Appointment " + id + " has been rescheduled to "
                + newTime.format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm")) + " by Dr. " + doctor.getLastName()
                + ".";
    ...
    public void cancel() {
        ...
        String msg = "Appointment " + id + " with Dr. " + doctor.getLastName() + " on " + this.dateTime.toLocalDate()
                + " has been CANCELLED.";
        this.doctor.notifyObservers(msg);
    ...
    public String toString() {
        return String.format("RDV ID: %s | Dr. %s | Patient: %s | Time: %s | Status: %s",
                id, doctor.getLastName(), patient.getLastName(),
                dateTime.format(DateTimeFormatter.ofPattern("dd/MM/yyyy HH:mm")), status);
    }
}